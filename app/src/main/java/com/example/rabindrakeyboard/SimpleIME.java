/*
   ...
   Contact: sucharit@math.ucla.edu
    ...
    This file is part of RabindraKeyboard.

    RabindraKeyboard is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    RabindraKeyboard is distributed in the hope that it will be useful,
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        switch(primaryCode){
            ...
            default:
                ...
                ic.commitText(scode,scode.length());
                scode="";
        }
    }
